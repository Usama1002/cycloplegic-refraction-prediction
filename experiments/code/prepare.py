...
def load_and_clean_data():
    """Load the anonymized CSV dataset."""
...
FEATURE_GROUPS = {
    "eyerobo_pre": ["eyerobo_pre_SPH", "eyerobo_pre_CYL", "eyerobo_pre_AX", "eyerobo_pre_pupil"],
    "eyerobo_post": ["eyerobo_post_SPH", "eyerobo_post_CYL", "eyerobo_post_AX", "eyerobo_post_pupil"],
    "auto_pre": ["auto_pre_SPH", "auto_pre_CYL", "auto_pre_AX"],
    "auto_post": ["auto_post_SPH", "auto_post_CYL", "auto_post_AX"],
    "iol_pre": ["iol_pre_AL", "iol_pre_LT", "iol_pre_WTW", "iol_pre_CCT", "iol_pre_Pupil",
                "iol_pre_SE", "iol_pre_K1", "iol_pre_K2", "iol_pre_dK", "iol_pre_ACD"],
    "iol_post": ["iol_post_AL", "iol_post_LT", "iol_post_WTW", "iol_post_CCT", "iol_post_Pupil",
...
SCENARIOS = {
    ...
    "S5_all_pre_post": ["eyerobo_pre", "eyerobo_post", "auto_pre", "auto_post", "iol_pre", "iol_post", "demographics"],
